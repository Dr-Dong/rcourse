...
### **Module 4:**  Data Presentation:  RMarkdown and ggplot2 (Feb 15^th^ and 16^th^)
...
documents,and beamer presentations.  Second, the ggplot2 package will also be 
introduced as a means to create compelling graphs and figures in R.
...
### **Module 5:** Regression Modelling in R (Feb 22^nd^ and 23^rd^)
...
### **Module 7:**  Intro to Bayesian Methods in R (March 1^st^)
