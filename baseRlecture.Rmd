...
subtitle: "Lecture 1: Basic Environment"
...
- Import and transform using standard R functions

- Extend R functionality through packages and user-written programming

- Create compelling presentations for data analysis projects

- Peform basic econometric analysis in R

- Learn basics of Bayesian methods in R
...
- So there's no excuse for really long lines.  Accepted style suggests use a 
...
matrix(x, nrow=a, nrow=b, byrow=FALSE/TRUE)
```
