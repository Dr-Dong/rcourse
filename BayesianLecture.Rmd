...
- Imagine I'm conducting a raffle lottery.  I have a large bowl, and inside of 
...
- Before reaching into the bowl, I want to know: 
  ...
  + Does this probability change if I tell you that all the numbers in the bowl 
  have at least 3 digits (ie $\geq 100$)?
...
- $p(x \leq 10)$ was always equal to zero, all that change was your knowledge of 
the experiment.
...
## Some Features of Bayesian methods
...
Show Stan and why it's too much work
...
TitanicGLMbasic <- stan_glm(Survived ~ Age + SexCode  + as.factor(class), 
...
## Plotting estimates with prediction intervals

http://rpubs.com/tjmahr/rstanarm-tour exampmle
